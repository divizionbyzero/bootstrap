...
class AppUser extends CActiveRecord
{
    ...
    public function rules()
    {
        return array(
            ...
            array('email', 'unique', 'attributeName'=>'email', 'message'=>'Введённый email уже существует'),
            array('password', 'required', 'on' => 'add, add_user'),
            array('is_active', 'boolean'),
            array('photo', 'file', 'types'=>'jpg, jpeg, png, gif', 'allowEmpty'=>true),
            array('first_name, last_name, nickname', 'safe'),
            array('first_name, last_name, nickname', 'required', 'on'=>'add_user, edit_user')
        );
    }
